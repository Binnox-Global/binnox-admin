  ...
  return (
    <div className="flex flex-col gap-[50px] text-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
        ...
        {/* Right Column - Cards */}
        <div className="space-y-8">
          <Link href={`./${businessId}/offers`} className="min-w-[338px] w-full h-[52px] px-[10.87px] py-5 bg-black rounded-md justify-center items-center gap-1.5 inline-flex overflow-hidden text-white text-sm font-bold font-['Raleway'] leading-[11.10px] tracking-tight">
