...
const defaultBusinesses: Business[] = [
  { id: '1', name: 'Second Pot', email: 'Secondpot@gmail.com', contact: '+2348156790543', location: 'Abuja', status: 'active', verified: true, wallet: 54345.00 },
  { id: '2', name: 'Exclusive Stores', email: 'Excstor@gmail.com', contact: '+2348156790543', location: 'Lagos', status: 'inactive', verified: true, wallet: 54345.00 },
  { id: '3', name: 'Dominos Pizza', email: 'Dominozpizz@gmail.com', contact: '+2348156790543', location: 'Kano', status: 'inactive', verified: false, wallet: 0.00 },
  { id: '4', name: 'Fast Food', email: 'Fastfood@gmail.com', contact: '+2348156790543', location: 'Abuja', status: 'active', verified: false, wallet: 0.00 },
  { id: '5', name: 'Sweet Treats', email: 'sweettreats@gmail.com', contact: '+2348156790543', location: 'Lagos', status: 'active', verified: true, wallet: 32150.00 },
  { id: '6', name: 'Burger King', email: 'burgerking@gmail.com', contact: '+2348156790543', location: 'Kano', status: 'inactive', verified: false, wallet: 0.00 },
  { id: '7', name: 'Food Palace', email: 'foodpalace@gmail.com', contact: '+2348156790543', location: 'Abuja', status: 'active', verified: true, wallet: 28900.00 },
  { id: '8', name: 'Quick Bites', email: 'quickbites@gmail.com', contact: '+2348156790543', location: 'Lagos', status: 'active', verified: true, wallet: 41200.00 },
  { id: '9', name: 'Tasty Foods', email: 'tastyfoods@gmail.com', contact: '+2348156790543', location: 'Kano', status: 'inactive', verified: false, wallet: 0.00 },
  { id: '10', name: 'Chicken Republic', email: 'chickenrep@gmail.com', contact: '+2348156790543', location: 'Abuja', status: 'active', verified: true, wallet: 67500.00 },
  { id: '11', name: 'Local Delights', email: 'localdelights@gmail.com', contact: '+2348156790543', location: 'Lagos', status: 'active', verified: true, wallet: 23400.00 },
  { id: '12', name: 'Spice Kitchen', email: 'spicekitchen@gmail.com', contact: '+2348156790543', location: 'Kano', status: 'inactive', verified: false, wallet: 0.00 }
];
...
export const BusinessList = () => {
  ...
  const onlineCount = defaultBusinesses.filter(b => b.status === 'active').length;
  ...
  const filteredAndSortedBusinesses = useMemo(() => {
    ...
    if (activeFilters.verified) {
      result = result.filter(business => 
        activeFilters.verified === 'verified' ? business.verified : !business.verified
      );
    }

    if (activeFilters.location) {
      result = result.filter(business => business.location === activeFilters.location);
    }
                ...
                <div className="absolute right-0 top-12 bg-white rounded-lg shadow-lg p-4 w-64 z-10 border border-[#EAECF0]">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="">All</option>
                        {Array.from(new Set(defaultBusinesses.map(b => b.location))).map(location => (
