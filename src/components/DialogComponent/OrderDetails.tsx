...
function OrderDetails() {
  return (
    ...
    <div className="w-[8 97px] w-full border h-[1199px] flex bg-[#f2f2f2] overflow-hidden rounded-[30px] shadow-[0px_-4px_4px_0px_rgba(244,244,244,1.00)]">
      ...
      <div className=" w-full p-[30px] pt-[40px] flex flex-col gap-[30px]">
        {/* header */}
        <div className="h-[90px] w-full pb-5 pt-8 border-b border-black/10 justify-start items-start gap-12 inline-flex">
          <div className="flex-col w-full justify-center items-start gap-2 inline-flex">
          ...
          <div className="justify-start items-center gap-2.5 flex">
            <div className="px-4 py-2.5 text-nowrap bg-black rounded-lg justify-start items-center gap-2 flex">
        ...
        <div className=" flex-col justify-start items-start gap-[30px] inline-flex w-full ">
          ...
          {/* card */}
          <div className="max-h-[271.65px]  relative p-5 bg-white rounded-[20px] flex-col justify-start items-start gap-[9.24px] inline-flex w-full">
            {/*  */}
            <div className="w-full h-[71.06px] relative">
              {/* line */}
              <div className="w-[90%] h-[2.12px] left-[38.81px] right-[30px] top-[29.16px] absolute bg-[#d2d2d2] rounded-sm border" />
              <div className="w-full h-[71.06px] pb-[13.86px] left-0 top-0 absolute border-b justify-evenly items-start gap-[41.27px] inline-flex">
                {/* time */}
        ...
        {/* product details */}
        <div className="h-[606px] w-full  flex-col justify-start items-start gap-2.5 inline-flex">
          <div className="justify-start items-start gap-[275.60px] inline-flex">
            <div className="text-black text-xl font-bold font-['Raleway']">
              Products details
            </div>
          </div>
          <div className="justify-between items-start gap-[28 7px] inline-flex w-full">
          ...
          <div className="w-full mt-[10px] h-[0px] border border-[#e9e9e9]"></div>
          <div className="flex-col justify-start items-start gap-5 flex w-full">
            ...
            <div className="w-full px-[9px] py-[15px] bg-[#e9e9e9] rounded-[10px] justify-start items-center gap-2.5 inline-flex overflow-hidden text-justify text-[#373434]/60 text-xs font-semibold font-['Raleway'] leading-none">
          ...
          <div className="justify-between items-start gap-[37 7px] inline-flex w-full">
          ...
          <div className="w-full h-[0px] border border-[#e9e9e9]"></div>
          ...
          <div className="w-full h-[0px] border border-[#e9e9e9]"></div>
          <div className="h-[94px] justify-between items-start  inline-flex w-full">
